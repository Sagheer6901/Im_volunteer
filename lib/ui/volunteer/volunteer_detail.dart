...
import 'package:i_am_volunteer/controllers/volunteer_detail_controller.dart';
...
class _VolunteerDetailsState extends State<VolunteerDetails>
  ...
  void initState() {
    super.initState();
    controller.listenToComments(widget.volunteer['uid']);
  ...
  Widget build(BuildContext context) {
    ...
    return CustomScaffold(
      body: _getBody(widget.volunteer),
      showBottomNavigation: false,
      onWillPop: controller.onBack,
      scaffoldKey: controller.scaffoldKey,
      screenName: 'Volunteer Details',
    );
  }
